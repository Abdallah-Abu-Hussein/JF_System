...
public class Cargo_Flights extends Flight {
    ...
    public Cargo_Flights(int flight_Number, int duration, Airport departing_Airport, Airport arrival_Airport, com.company.Aircraft aircraft, com.company.Pilot pilot, int load_In_Tons, int cost_per_Ton) {
